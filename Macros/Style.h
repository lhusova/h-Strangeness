...
//Float_t LimInfMultRatio = 0;
//Float_t LimSupMultRatio = 2.5;
Float_t UpRangePt[nPtTriggBins] = {15, 10, 10, 6};
Float_t OffsetX[nPtTriggBins] = {0.6, 0.5, 0.4, 0.3};

//Float_t LimInfMultRatio = 0.6* 1e-1;
//Float_t LimSupMultRatio = 16;
Float_t LimInfMultRatio = 0.2;
Float_t LimSupMultRatio = 6;
...
Int_t ColorMult[] = {634, 628, 797, kOrange - 4, 815, 418, 429, 867, 856, 601, kViolet, kPink + 9, kPink + 1, 1};
...
Float_t SizeMultRatio[] = {1.3, 1.3, 1.3, 1.3, 1.3, 1.3, 1.3, 1.3, 1.3};
...
//Float_t ScaleFactor[] = {256, 128, 64, 32, 16, 8, 4, 2, 1}; working when we start from 70-100%
Float_t ScaleFactor[] = {128, 64, 32, 16, 8, 4, 2, 1};
Int_t ColorMB = 1;
Float_t SizeMB = 2;
Int_t MarkerMB = 24;
...
TString multiplicityPave[] = {"0#minus100%", "0#minus1%", "1#minus10%", "10#minus20%", "20#minus30%", "30#minus40%", "40#minus50%", "50#minus70%", "70#minus100%"};
...
TString TitleYProbDensity = "Probability density";
